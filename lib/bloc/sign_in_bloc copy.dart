...
class LokiPolsae extends ChangeNotifier {
  ...
  Future signUpwithEmailPassword (userName,userEmail, userPassword,userPhone,provinsi,jumlahAnak) async{
    try{
      final User? user = (await _firebaseAuth.createUserWithEmailAndPassword(email: userEmail,password: userPassword,)).user!;
      assert(user != null);  
      await user!.getIdToken();
      this._jumlahAnak = jumlahAnak;
